...
namespace JudgeSystem.Services.Data
{
    public class UserService : IUserService
	{
        ...
        private readonly IOptions<DefaultUserPasswordSettings> settings;
        ...
        public UserService(
            ...
            IStudentService studentService, UserManager<ApplicationUser> userManager,
            IOptions<DefaultUserPasswordSettings> settings)
        {
        ...
        public async Task ImportWithPassAsync(IEnumerable<UserImportServiceModel> users)
        {
            var entities = users.Select(u => new ApplicationUser
            {
                Email = u.Email,
                EmailConfirmed = true,
                UserName = UserHelper.GetUsernameFromEmail(u.Email),
            ...
            {
                await userManager.CreateAsync(item, settings.Value.Password);
            }
        }
    }
}
